...
PlayMethodScene::PlayMethodScene() : dx9GpuDescriptor{}
{
    //コンストラクター
    //変数の初期化（0にする）
...
void PlayMethodScene::Initialize()
{
    //ゲームシーンの初期化
    //変数を初期化（具体的な数値を設定する）
    //サウンドを読み込んだりする
...
void PlayMethodScene::LoadAssets()
{
    //グラフィックの設定をする
...
void PlayMethodScene::Terminate()
{
...
void PlayMethodScene::OnDeviceLost()
{
...
void PlayMethodScene::OnRestartSound()
{
...
// Updates the scene.
NextScene PlayMethodScene::Update(const float deltaTime)
{
